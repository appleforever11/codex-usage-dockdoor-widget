...
for attempt in 1 2 3; do
    ...
    : >"$error_file"
    {
        printf '%s\n' '{"id":1,"method":"initialize","params":{"clientInfo":{"name":"dockdoor-codex-usage-sync","title":"DockDoor Codex Usage Sync","version":"4.1.0"},"capabilities":{"experimentalApi":true,"requestAttestation":false}}}'
        sleep 0.25
